...
public class WxXmlUtil {
    ...
    public static Map<String, String> xmlToMap(String strXML) throws Exception {
        try {
            ...
            WxXmlUtil.getLogger().warn("Invalid XML, can not convert to map. Error message: {}. XML content: {}", ex.getMessage(), strXML);
            throw ex;
        }
    ...
    public static String mapToXml(Map<String, String> data, Map<String, String> inner) throws Exception {
        ...
        for (String key: data.keySet()) {
            ...
            if ("true".equals(value)) {
                for (String inKey : inner.keySet()) {
                    org.w3c.dom.Element inRoot = document.createElement(key);
                    String inValue = inner.get(inKey);
                    org.w3c.dom.Element inFiled = document.createElement(inKey);
                    inFiled.appendChild(document.createTextNode(inValue));
                    inRoot.appendChild(inFiled);
    ...
    public static boolean isSignatureValid(String xmlStr, String key) throws Exception {
        ...
        String sign = data.get(WxConstant.SIGN);
    ...
    public static boolean isSignatureValid(Map<String, String> data, String key) throws Exception {
        return isSignatureValid(data, key, WxConstant.MD5);
    }
    ...
    public static String generateSignature(final Map<String, String> data, String key) throws Exception {
        return generateSignature(data, key, WxConstant.MD5);
    }
